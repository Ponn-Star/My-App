...
const API_TOKEN_INTRODUCE = "Q77FhyKItb24O_dHv26GYa18PrWrLXeTH5A7FPFn";

export async function Introduce() {
  return callApi(API_URL_INTRODUCE, API_TOKEN_INTRODUCE);
}

const API_URL_DASHBOARD = "https://app.nocodb.com/api/v2/tables/m6lh8lg4oi1koz2/records?offset=0&limit=25&where=&viewId=vw2thmym51hdo6n3";
const API_TOKEN_DASHBOARD = "Q77FhyKItb24O_dHv26GYa18PrWrLXeTH5A7FPFn";

export async function Dashboard() {
  return callApi(API_URL_DASHBOARD, API_TOKEN_DASHBOARD);
}